...
### Slide 5. Benchmark System and Data
...
### Slide 6. Training and Evaluation Split
...
### Slide 8. Neural ODE Formulation
...
### Slide 10. Numerical Solver and Training
...
### Slide 12. Extension II: Bayesian+NN
...
### Slide 13. Why These Extensions Matter
...
### Slide 18. Comparison Across Methods
...
```mermaid
flowchart LR
    A[Observed Atmospheric Data] --> B[State Preprocessing]
    B --> C[Neural ODE Model]
    C --> D[Learned Dynamics f_theta(y)]
    D --> E[ODE Solver RK4]
    E --> F[Forecast Trajectory]
    C --> G[KF-based State Update]
    C --> H[Bayesian Uncertainty Modeling]
```
